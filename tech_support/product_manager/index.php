<?php
/**
 * File name: product_manager\index.php
...
require('../model/database.php');           //database connection file
require('../model/product_db.php');         //database interaction functions


//if block looking for either a GET or a POST
//todo post not being seen. ALWAYS 'show products'
...
//todo remove after fixing post failure
echo $action;

//directs to under construction page in case
if ($action == 'under_construction') {
    ...
    if (empty($product_code) || empty($name) || empty($version)
        ...
        //todo does this actually work? check it after POST issue is resolved
